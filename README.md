...
基于鼠须管 Squirrel 1.1.2 的 macOS 输入法改造，当前版本 **1.1.2.11**。中文候选由 Rime 负责，幽灵续写由本机专用 MLX 服务运行 `mlx-community/MiniCPM5-1B-4bit`。项目名称为“投机输入法”，支持上屏后续写与选词期间的编码预测。
...
本机目录的 `dist/Squirrel-Ghost-1.1.2.11.pkg` 已附带整理时的安装包。今后运行打包脚本可以从当前源码重新生成。
